...
private:
    ...
    bool isInterfaceFromHiddenUsb(const QString &ifName);
...
private:
    ...
    QString m_projectInfo;
    bool m_isOdmyke = false;
    QVector<QPair<QString, QString>> m_hiddenVidPid; // vendor, product pairs (lowercase hex)
};
