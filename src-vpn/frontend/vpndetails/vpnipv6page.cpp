...
void VpnIpv6Page::initUI()
{
    ...
    QRegularExpressionValidator *ipv6ExpVal = new QRegularExpressionValidator(ipv6_rx, this);
    ...
    m_netMaskEdit->setValidator(new QRegularExpressionValidator(prefix_rx,this));
}
