...
INCLUDEPATH += /usr/include/kylin-nm
INCLUDEPATH += /usr/include/kylin-nm-depend

LIBS +=  -L/usr/lib/ -lgsettings-qt -lX11 -lKF5NetworkManagerQt -lkylin-nm-base -lkylin-nm-external
