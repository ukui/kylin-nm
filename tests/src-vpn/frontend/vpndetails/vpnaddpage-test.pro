...
SOURCES += ../../../../src-vpn/frontend/vpndetails/vpnaddpage.cpp
...
SOURCES += $$PWD/test_vpnaddpage.cpp
SOURCES += $$PWD/main.cpp

HEADERS += ../../../../src-vpn/frontend/vpndetails/vpnaddpage.h
