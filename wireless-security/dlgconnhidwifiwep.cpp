    ...
    ui(new Ui::DlgConnHidWifiWep)
{
    ...
    ui->lbKey->setStyleSheet("QLabel{color:rgba(255,255,255,0.97);background-color:transparent;}");
    ui->lbWEPindex->setStyleSheet("QLabel{color:rgba(255,255,255,0.97);background-color:transparent;}");
    ui->lbAuth->setStyleSheet("QLabel{color:rgba(255,255,255,0.97);background-color:transparent;}");
    ui->btnCancel->setStyleSheet("QLabel{color:rgba(255,255,255,0.97);background-color:transparent;}");
    ui->btnConnect->setStyleSheet("QLabel{color:rgba(255,255,255,0.97);background-color:transparent;}");
    ...
    ui->cbxSecurity->setStyleSheet("QComboBox{padding-left:20px;font-size:13px;color:rgba(255,255,255,1);border:1px solid rgba(255, 255, 255, 0.05);background:rgba(255,255,255,0.08);}"
                              "QComboBox::drop-down{border:0;width:30px;}"
                              "QComboBox::down-arrow{image:url(:/res/g/down_arrow.png);}");
    ui->cbxWEPindex->setStyleSheet("QComboBox{padding-left:20px;font-size:13px;color:rgba(255,255,255,1);border:1px solid rgba(255, 255, 255, 0.05);background:rgba(255,255,255,0.08);}"
                              "QComboBox::drop-down{border:0;width:30px;}"
                              "QComboBox::down-arrow{image:url(:/res/g/down_arrow.png);}");
